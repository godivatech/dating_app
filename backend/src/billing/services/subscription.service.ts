    ...
    try {
      ...
      const defaultProducts = [
        ...
        },
        {
          ...
          billingPeriod: BillingPeriod.ONE_TIME,
          isActive: true,
          metadata: { coinsCount: 100, bonusPercentage: 0, badge: 'Starter', type: 'COINS' },
        },
        {
          productKey: 'SPARK_COINS_250',
          displayName: '250 Coins (+25% Extra)',
          description: 'Best value for active daters: 200 + 50 free bonus coins.',
          tier: SubscriptionTier.A_LA_CARTE,
          platform: DevicePlatform.IOS,
          ...
          billingPeriod: BillingPeriod.ONE_TIME,
          isActive: true,
          metadata: { coinsCount: 250, bonusPercentage: 25, badge: 'Most Popular', type: 'COINS' },
        },
        {
          productKey: 'SPARK_COINS_700',
          displayName: '700 Coins (+40% Extra)',
          description: 'Maximum dating power: 500 + 200 free bonus coins for serious daters.',
          tier: SubscriptionTier.A_LA_CARTE,
          platform: DevicePlatform.IOS,
          ...
          billingPeriod: BillingPeriod.ONE_TIME,
          isActive: true,
          metadata: { coinsCount: 700, bonusPercentage: 40, badge: 'Best Value', type: 'COINS' },
        },
        // Direct Note Packs
        {
