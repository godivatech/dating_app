...
export const strings = {
  en: {
    ...
    navPremium: 'Spark Premium',
    navPremiumSubtitle: 'Subscriptions, perks & capabilities',
    upgradeToPlus: 'Upgrade to Spark Plus',
    upgradeToGold: 'Upgrade to Spark Gold',
    ...
    unlockWithGold: 'Unlock with Spark Gold',
    ...
    outOfLikesDesc: 'Free users get 25 likes every 24 hours. Upgrade to Spark Plus for unlimited daily likes.',
    rewindLockTitle: 'Rewind is a Premium Perk',
    rewindLockDesc: 'Accidentally swiped left? Spark Plus lets you rewind your last pass instantly.',
  },
  ta: {
    // App & Common
    appName: 'ஸ்பார்க் டேட்டிங்',
    loading: 'ஏற்றுகிறது...',
    save: 'சேமி',
    cancel: 'ரத்துசெய்',
    close: 'மூடு',
    ...
    // Monetization & Entitlements
    navPremium: 'ஸ்பார்க் பிரீமியம்',
    navPremiumSubtitle: 'சந்தா & சிறப்பம்சங்கள்',
    upgradeToPlus: 'ஸ்பார்க் பிளஸ் பெறுக',
    upgradeToGold: 'ஸ்பார்க் கோல்ட் பெறுக',
    ...
    unlockWithGold: 'ஸ்பார்க் கோல்ட் மூலம் திறக்கவும்',
    ...
    freeTier: 'இலவச பயனர்',
    plusTier: 'ஸ்பார்க் பிளஸ்',
    goldTier: 'ஸ்பார்க் கோல்ட்',
    rewindSuccess: 'சுயவிவரம் மீட்டெடுக்கப்பட்டது!',
    outOfLikesTitle: 'இன்றைய விருப்பங்கள் முடிந்தது!',
    outOfLikesDesc: 'இலவச பயனர்களுக்கு ஒரு நாளைக்கு 25 விருப்பங்கள். வரம்பற்ற விருப்பங்களுக்கு ஸ்பார்க் பிளஸ் பெறுக.',
    rewindLockTitle: 'மீட்டெடுத்தல் ஒரு பிரீமியம் வசதி',
    rewindLockDesc: 'தவறுதலாகத் தவிர்த்துவிட்டீர்களா? ஸ்பார்க் பிளஸ் மூலம் உடனே மீட்டெடுக்கலாம்.',
  },
};
